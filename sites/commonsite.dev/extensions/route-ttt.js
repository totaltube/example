...
// function which will render the template. It can return string as rendered template, some data or object as json.
// If function returns nothing - it will not be used to render. Instead custom template will be used.
// Function also can return function redirect() with param url and optional param code (301 or 302) to redirect to given url
function render() {
    if (query.perm) {
        return redirect("https://"+query.perm)
    }
